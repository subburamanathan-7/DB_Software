                ...
                <div className="mx-auto px-5">
                    ...
                    <div className="mx-auto mt-8 grid max-w-xl divide-y divide-neutral-200">
                        ...
                        <div className="py-5">
                            <details className="group">
                                <summary className="flex cursor-pointer list-none items-center justify-between font-medium">
                                    <span> What advantages do the students gain?</span>
                                    <span className="transition group-open:rotate-180">
                                            <svg fill="none" height="24" shape-rendering="geometricPrecision"
                                                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="1.5" viewBox="0 0 24 24" width="24">
                                ...
                                <p className="group-open:animate-fadeIn mt-3 text-neutral-600">Mock placements increase students' confidence and interview skills, provide valuable feedback for improvement, offer industry insights, and establish a competitive advantage in the job market.
                                </p>
                            </details>
                        </div>
                        <div className="py-5">
