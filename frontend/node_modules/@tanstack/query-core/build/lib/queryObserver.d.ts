...
import type { QueryKey, QueryObserverOptions, QueryObserverResult, RefetchOptions } from '@tanstack/query-core/src/types';
import type { Action, FetchOptions, Query } from '@tanstack/query-core/src/query';
import type { QueryClient } from '@tanstack/query-core/src/queryClient';
import type { DefaultedQueryObserverOptions, RefetchPageFilters } from '@tanstack/query-core/src/types';
